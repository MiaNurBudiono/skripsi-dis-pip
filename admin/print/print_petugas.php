...
$pdf->Cell(240,7,'',0,2);
$pdf->SetFont('Times','B',14);
$pdf->Cell(240,7,'DATA PETUGAS PENGURUS PIP',0,2,'C');
...
$pdf->SetWidths(array(7,50,50,40,35,30,30,55));
while($data = mysqli_fetch_array($query)){
    $no++;
    $pdf->Cell(15,10,'',0,0);
$pdf->Row(array($no,$data['nama'],$data['nip'],$data['tempat_lahir'],$data['tgl_lahir'],$data['jabatan'],$data['no_hp'],
$data['email']));
}
