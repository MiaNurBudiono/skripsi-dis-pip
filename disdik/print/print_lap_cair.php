...
$pdf->Cell(240,7,'',0,2);
$pdf->SetFont('Times','B',14);
$pdf->Cell(240,7,'LAPORAN PENCAIRAN DANA PIP',0,2,'C');
$pdf->SetFont('Times','',12);
...
$pdf->SetFont('Times','',10);
$query = mysqli_query($koneksi, "SELECT lap_cair.*,s_rekom_layak .*,layak_pip.*, data_siswa.* FROM lap_cair
...
$pdf->SetWidths(array(7,45,20,18,13,13,20,25,30,30,20,45,30,20));
