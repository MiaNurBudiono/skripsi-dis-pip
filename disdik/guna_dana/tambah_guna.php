...
if (isset($_POST['submit'])) {
  ...
  foreach($_POST as $key => $val){
      ${$key} = $val;
        ...
        $query = mysqli_query($koneksi, "INSERT INTO guna_dana SET id_sdn='$asal' ,periode = '$periode', tahun='$tahun' ");
       if ($query) {
           echo "<script> alert('Berhasil Menyimpan Data');
           window.location = '?page=rekap_guna_dana';
           </script>";
        }else {
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Rekap Penggunaan Dana PIP</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Form Tambah Rekap Penggunaan Dana PIP</h1>
			</div>
		</div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-15"> 
            <div class="panel panel-default">
                <div class="panel-heading">Form Rekap Penggunaan Dana PIP </div>
                <div class="panel-body" style="background: #F0FFFF">
                    <div class="col-md-6">
                        ...
                        <?//perlu ditambahkan kolom apa lagi? bingung?>
