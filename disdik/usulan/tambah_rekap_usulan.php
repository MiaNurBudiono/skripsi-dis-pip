...
if (isset($_POST['submit'])) {
  ...
  foreach($_POST as $key => $val){
      ${$key} = $val;
        ...
        $query = mysqli_query($koneksi, "INSERT INTO rekap_usul SET id_sdn='$id_sdn',periode = '$periode', tahun='$tahun' ");
       if ($query) {
           echo "<script> alert('Berhasil Menyimpan Data');
           window.location = '?page=rekap_usul';
           </script>";
        }else {
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Rekap Usul Bantuan</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Form Tambah Rekap Usul Bantuan</h1>
			</div>
		</div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-15"> 
            <div class="panel panel-default">
                <div class="panel-heading">Form Rekap Usul Bantuan </div>
                <div class="panel-body" style="background: #F0FFFF">
                    <div class="col-md-6">
                        <form role="form" method = "POST" action="" enctype="multipart/form-data">
                            <div class="form-group">
                            <label>NPSN/Nama Sekolah</label>
                            <select class="form-control js-example-basic-single" name="id_sdn">
